...
public class PetMedicalRecordServiceImpl implements IPetMedicalRecordService
{
    ...
    public int updatePetMedicalRecord(PetMedicalRecord petMedicalRecord) {
        PetMedicalRecord record = petMedicalRecordMapper.selectByPrimaryKey(petMedicalRecord.getId());
        record.setDisease(petMedicalRecord.getDisease());
        record.setMethod(petMedicalRecord.getMethod());
        record.setRemake(petMedicalRecord.getRemake());
        record.setUpdateTime(new Date());
        petMedicalRecordMapper.updateByPrimaryKey(record);
        return 1;
    }
