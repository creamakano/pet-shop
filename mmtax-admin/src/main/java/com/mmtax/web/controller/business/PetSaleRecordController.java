...
public class PetSaleRecordController extends BaseController
{
	...
	@PostMapping("/edit")
	@ResponseBody
	public AjaxResult editSave(PetSaleRecord petSaleRecord,String phonenumber)
	{		
		return toAjax(petSaleRecordService.updatePetSaleRecord(petSaleRecord,phonenumber));
	}
